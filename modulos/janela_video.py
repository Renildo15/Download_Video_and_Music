...
def abrir_janela_video():
    ...
    botao = Button(janela, text="Baixar", command=lambda: download_video(link_music, path_music, label_test), width=20, font="San-serif 15", bd=0, bg="red", cursor="star", justify=CENTER, fg="white")
    label_test = Label(janela, text="", font=("San-serif 20"), pady=20)
